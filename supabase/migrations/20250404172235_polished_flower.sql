/*
  # Add statistics functions for admin dashboard
  
  1. New Functions
    - `get_user_transfer_stats` - Returns statistics by user
    - `get_direction_transfer_stats` - Returns statistics by transfer direction
    
  2. Description
    These functions aggregate transfer data for completed transfers only,
    providing total amounts and counts for administrative reporting.
*/
