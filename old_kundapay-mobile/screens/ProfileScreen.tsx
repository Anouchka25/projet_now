      ...
      <View style={styles.card}>
        ...
        {profile && (
          <View style={styles.profileInfo}>
            ...
            <Text style={styles.value}>{formatName(profile.first_name, profile.last_name)}</Text>
            ...
            <View key={transfer.id} style={styles.transferCard}>
              ...
              <View style={styles.transferDetails}>
                ...
                {transfer.beneficiaries && transfer.beneficiaries.length > 0 && (
                  <Text>Bénéficiaire: {formatName(transfer.beneficiaries[0]?.first_name || '', transfer.beneficiaries[0]?.last_name || '')}</Text>
                )}
                <Text style={[
                  styles.status,
